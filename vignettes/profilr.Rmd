...
```{r}
kable(limestone, align=rep('c', nrow(limestone)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
...
kable(meanvar_results, align=rep('c', nrow(meanvar_results)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
<br>
<br>
...
kable(converted_meanvar_results, align=rep('c', nrow(converted_meanvar_results)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
<br>
<br>
...
kable(mean_results, align=rep('c', nrow(mean_results)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
<br>
<br>
...
kable(var_results, align=rep('c', nrow(var_results)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
<br>
<br>
...
kable(all_results, align=rep('c', nrow(all_results)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
```
<br>
<br>
...
kable(stats_df, align=rep('c', nrow(stats_df)))%>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered")) %>%   scroll_box(width = "700px", height = "200px")
